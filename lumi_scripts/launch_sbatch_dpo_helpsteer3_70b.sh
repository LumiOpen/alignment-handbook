#!/bin/bash
#SBATCH --job-name=dpo_70b_helpsteer3
...
export HF_DATASETS_CACHE="/scratch/project_462000353/zosaelai2/datasets_cache3"
...
CONFIG_FILE=recipes/llama-3/dpo/config_helpsteer3_eng_fin_70b.yaml
