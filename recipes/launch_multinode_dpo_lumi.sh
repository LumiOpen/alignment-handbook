...
source /scratch/project_462000353/zosaelai2/.handbook_venv_moe/bin/activate
...
export PYTHONPATH="/scratch/project_462000353/zosaelai2/.handbook_venv_moe/lib/python3.11/site-packages"
...
export CMD=" \
    ...
    --eval_strategy steps \
    --eval_steps 50 \
    --output_dir data/Qwen3-30B-A3B-DPO \
